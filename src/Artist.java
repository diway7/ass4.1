...
public class Artist {
    ...
    public boolean equals(Object obj) {
        if (this == obj) {
            ...
            return this.birthYear == artist.birthYear && this.name.equals(artist.name) && this.surname.equals(artist.surname) && this.country.equals(artist.country);
        } else {
            return false;
        }
    }
    ...
    public int hashCode() {
        return Objects.hash(new Object[]{this.name, this.surname, this.birthYear, this.country});
    }
}
